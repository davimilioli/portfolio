...
import SkillsContent from '@/components/home/skills/SkillsContent';

export default function Skills() {
    return (
        <section className="relative w-full text-white py-16 md:py-24 overflow-hidden bg-[#09090b] bg-[radial-gradient(ellipse_at_30%_5%,rgba(59,130,246,0.09)_0%,rgba(9,9,11,0)_50%),radial-gradient(ellipse_at_70%_95%,rgba(139,92,246,0.08)_0%,rgba(9,9,11,0)_50%)]">
